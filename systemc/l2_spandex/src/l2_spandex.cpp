...
void l2_spandex::send_req_out(coh_msg_t coh_msg, hprot_t hprot, line_addr_t line_addr, line_t line)
{
    SEND_REQ_OUT;
...
void l2_spandex::send_rsp_out(coh_msg_t coh_msg, cache_id_t req_id, bool to_req, line_addr_t line_addr, line_t line)
{
    SEND_RSP_OUT;
...
void l2_spandex::send_req_out_word_mask(coh_msg_t coh_msg, hprot_t hprot, line_addr_t line_addr, line_t line, word_mask_t word_mask)
{
    l2_req_out_t req_out;
...
void l2_spandex::send_rsp_out_word_mask(coh_msg_t coh_msg, cache_id_t req_id, bool to_req, line_addr_t line_addr, line_t line, word_mask_t word_mask)
{
    l2_rsp_out_t rsp_out;
...
void l2_spandex::put_reqs(l2_set_t set, l2_way_t way, l2_tag_t tag, line_t line, hprot_t hprot, state_t state,
		  sc_uint<REQS_BITS> reqs_i)
{
    PUT_REQS;
...
void l2_spandex::tag_lookup(addr_breakdown_t addr_br, bool &tag_hit, l2_way_t &way_hit, bool &empty_way_found,
		    l2_way_t &empty_way)
{
    TAG_LOOKUP;
...
void l2_spandex::tag_lookup_fwd(line_breakdown_t<l2_tag_t, l2_set_t> line_br, bool &tag_hit, l2_way_t &way_hit)
{
    TAG_LOOKUP;
...
bool l2_spandex::reqs_peek_req(l2_set_t set, sc_uint<REQS_BITS> &reqs_i)
{
    REQS_PEEK_REQ;
...
bool l2_spandex::reqs_peek_fwd(line_breakdown_t<l2_tag_t, l2_set_t> line_br,
