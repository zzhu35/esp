...
void l2_gpu::get_cpu_req(l2_cpu_req_t &cpu_req)
{
    GET_CPU_REQ;
...
void l2_gpu::get_fwd_in(l2_fwd_in_t &fwd_in)
{
    L2_GET_FWD_IN;
...
void l2_gpu::get_rsp_in(l2_rsp_in_t &rsp_in)
{
    L2_GET_RSP_IN;
...
void l2_gpu::send_rd_rsp(line_t line)
{
    SEND_RD_RSP;
...
void l2_gpu::send_inval(line_addr_t addr_inval)
{
    SEND_INVAL;
...
void l2_gpu::send_req_out(coh_msg_t coh_msg, hprot_t hprot, line_addr_t line_addr, line_t line, word_mask_t word_mask)
{
    SEND_REQ_OUT;
...
void l2_gpu::send_rsp_out(coh_msg_t coh_msg, cache_id_t req_id, bool to_req, line_addr_t line_addr, line_t line)
{
    // SEND_RSP_OUT;
...
#ifdef STATS_ENABLE
void l2_gpu::send_stats(bool stats)
{
    SEND_STATS;
...
void l2_gpu::fill_reqs(cpu_msg_t cpu_msg, addr_breakdown_t addr_br, l2_tag_t tag_estall, l2_way_t way_hit,
...
void l2_gpu::put_reqs(l2_set_t set, l2_way_t way, l2_tag_t tag, line_t line, hprot_t hprot, state_t state,
		  sc_uint<REQS_BITS> reqs_i)
{
    PUT_REQS;
...
inline void l2_gpu::read_set(l2_set_t set)
{
...
void l2_gpu::tag_lookup(addr_breakdown_t addr_br, bool &tag_hit, l2_way_t &way_hit, bool &empty_way_found,
		    l2_way_t &empty_way)
{
    TAG_LOOKUP;
...
void l2_gpu::tag_lookup_fwd(line_breakdown_t<l2_tag_t, l2_set_t> line_br, bool &tag_hit, l2_way_t &way_hit)
{
    TAG_LOOKUP;
...
void l2_gpu::reqs_lookup(line_breakdown_t<l2_tag_t, l2_set_t> line_br, sc_uint<REQS_BITS> &reqs_hit_i)
{
    REQS_LOOKUP;
...
bool l2_gpu::reqs_peek_req(l2_set_t set, sc_uint<REQS_BITS> &reqs_i)
{
    REQS_PEEK_REQ;
...
void l2_gpu::reqs_peek_flush(l2_set_t set, sc_uint<REQS_BITS> &reqs_i)
{
    REQS_PEEK_REQ;
...
bool l2_gpu::reqs_peek_fwd(line_breakdown_t<l2_tag_t, l2_set_t> line_br,
